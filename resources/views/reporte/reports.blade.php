    ...
    <div class="mb-6 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <select id="period" class="w-full h-10 rounded-lg border-gray-300 focus:border-[#2045c2] focus:ring-[#2045c2]" title="Selecciona el período de tiempo para filtrar los movimientos">
            ...
            <div>
                ...
                <select id="movement_type" class="w-full h-10 rounded-lg border-gray-300 focus:border-[#2045c2] focus:ring-[#2045c2]" title="Filtra por entradas o salidas de inventario">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" id="search" placeholder="Código o nombre..." class="w-full h-10 pl-10 pr-4 rounded-lg border border-gray-300 focus:border-[#2045c2] focus:ring-[#2045c2]" title="Busca por código o nombre del material">
...
<div id="background-overlay" style="
    ...
    width: 100%;
    height: 100%;
    background-image: url('{{ asset('img/Reportes.jpg') }}');
