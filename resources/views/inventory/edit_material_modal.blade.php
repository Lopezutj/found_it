...
<div class="p-6">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-[#2045c2] inline-block bg-white bg-opacity-40 px-4 py-2 rounded">EDITAR MATERIAL <p class="text-gray-600 mt-2 text-sm">Modifique la ubicación y cantidad del material</p></h1>
    </div>
