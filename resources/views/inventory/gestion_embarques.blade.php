                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <button title="Haz click para ver historial" onclick="openHistoryModal('{{$inventario->material->codigo}}')" class="text-[#2045c2] hover:text-[#ff3333] transition-colors duration-150">
