...
<head>
    ...
    <style>
        ...
        .tech-background {
            background: linear-gradient(45deg, #155dfc, #155dfc);
        ...
        <div class="w-full max-w-md bg-white bg-opacity-90 rounded-lg shadow-2xl overflow-hidden transform transition-all duration-1000 scale-95 hover:scale-100 slide-in"> <!-- CONTENDEDOR DEL LOGIN -->
            <div class="bg-blue-500 text-white p-8">
                ...
                <div class="text-center fade-in">
                    <h3 class="text-4xl font-bold mb-3">Bienvenido</h3>
                    <p class="italic text-lg"></p>
                </div>
                  <!-- Logo -->
            <div class="flex justify-center mt-6">
                <img src="{{ asset('img/logofound-it.jpg') }}" alt="Logo Found It" class="h-40 w-15">
            </div>
            </div>
